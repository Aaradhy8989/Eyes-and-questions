...
class Screen:
    ...
    def clean(self):
        ...
        if os.path.isfile((os.path.join('Resources','miss_minutes.png'))):
            sh_image = cv2.imread(os.path.join('Resources','miss_minutes.png'), cv2.IMREAD_UNCHANGED)
